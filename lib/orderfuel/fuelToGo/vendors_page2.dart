...
class VendorsPage2 extends StatefulWidget {
  ...
  @override
  State<VendorsPage2> createState() => _VendorsPage2State();
}

class _VendorsPage2State extends State<VendorsPage2> {
  @override
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const CheckOutTo2(),
                      )),
                  child: Container(
                    height: 102,
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          Image.asset("assets/petrol.png", height: 94),
                          Padding(
                            padding:
